# Magento 2 Tier Price Table Extension

[Magento 2 Tier Price Table](https://www.ulmod.com/tier-price-table-for-magento-2.html)  is a Magento 2 extension that allows you to display the default Magento tier price list in form of a table.

With Magento 2 Tier Price Table, your buyers can easily select their tier price options from the table view  and see their savings/discounts right on the product page.

<a href="https://www.ulmod.com/tier-price-table-for-magento-2.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Display default tiers in form of the table 
* Work with simple, virtual, and downloadable products types
* Ability to define the tier price block title
* Auto-update quantity and price on each tier price selection
* Ability to manually reset/clear the selected options in the table via the reset button
* Ability to restrict tier price table display per specific product and store view
* Mobile-friendly
* Support multiple-stores


<img src="https://www.ulmod.com/media/ulmod/product_content/tier-table-front-f.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/tier-table-config-f.png">
